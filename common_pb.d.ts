...
export class Envelope extends jspb.Message {
  ...
  getRedactable(): boolean;
  setRedactable(value: boolean): void;

  getRedactMessage(): Uint8Array | string;
  getRedactMessage_asU8(): Uint8Array;
  getRedactMessage_asB64(): string;
  setRedactMessage(value: Uint8Array | string): void;
...
export namespace Envelope {
  export type AsObject = {
    ...
    signature: Uint8Array | string,
    redactable: boolean,
    redactMessage: Uint8Array | string,
  }
}

export class RedactMsg extends jspb.Message {
  getPk(): Uint8Array | string;
  getPk_asU8(): Uint8Array;
  getPk_asB64(): string;
  setPk(value: Uint8Array | string): void;

  getMsp(): Uint8Array | string;
  getMsp_asU8(): Uint8Array;
  getMsp_asB64(): string;
  setMsp(value: Uint8Array | string): void;

  getFameCipher(): Uint8Array | string;
  getFameCipher_asU8(): Uint8Array;
  getFameCipher_asB64(): string;
  setFameCipher(value: Uint8Array | string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RedactMsg.AsObject;
  static toObject(includeInstance: boolean, msg: RedactMsg): RedactMsg.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RedactMsg, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RedactMsg;
  static deserializeBinaryFromReader(message: RedactMsg, reader: jspb.BinaryReader): RedactMsg;
}

export namespace RedactMsg {
  export type AsObject = {
    pk: Uint8Array | string,
    msp: Uint8Array | string,
    fameCipher: Uint8Array | string,
  }
}
