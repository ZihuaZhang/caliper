...
goog.exportSymbol('proto.common.RedactMsg', null, global);
 ...
 * @constructor
 */
proto.common.RedactMsg = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.common.RedactMsg, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.common.RedactMsg.displayName = 'proto.common.RedactMsg';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.common.Envelope.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    signature: msg.getSignature_asB64(),
    redactable: jspb.Message.getBooleanFieldWithDefault(msg, 3, false),
    redactMessage: msg.getRedactMessage_asB64()
  };
...
proto.common.Envelope.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      msg.setRedactable(value);
      break;
    case 4:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
      msg.setRedactMessage(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.common.Envelope.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getRedactMessage_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      4,
      f
...
/**
 * optional bool redactable = 3;
 * @return {boolean}
 */
proto.common.Envelope.prototype.getRedactable = function() {
 ...
 * @return {!proto.common.Envelope} returns this
 */
proto.common.Envelope.prototype.setRedactable = function(value) {
  return jspb.Message.setProto3BooleanField(this, 3, value);
};


/**
 * optional bytes redact_message = 4;
 * @return {!(string|Uint8Array)}
 */
proto.common.Envelope.prototype.getRedactMessage = function() {
...
/**
 * optional bytes redact_message = 4;
 * This is a type-conversion wrapper around `getRedactMessage()`
 * @return {string}
 */
proto.common.Envelope.prototype.getRedactMessage_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getRedactMessage()));
};
 ...
 * @return {!Uint8Array}
 */
proto.common.Envelope.prototype.getRedactMessage_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getRedactMessage()));
};
 ...
 * @return {!proto.common.Envelope} returns this
 */
proto.common.Envelope.prototype.setRedactMessage = function(value) {
 ...
 * @return {!Object}
 */
proto.common.RedactMsg.prototype.toObject = function(opt_includeInstance) {
  return proto.common.RedactMsg.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.common.RedactMsg} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.RedactMsg.toObject = function(includeInstance, msg) {
  var f, obj = {
    pk: msg.getPk_asB64(),
    msp: msg.getMsp_asB64(),
    fameCipher: msg.getFameCipher_asB64()
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.common.RedactMsg}
 */
proto.common.RedactMsg.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.common.RedactMsg;
  return proto.common.RedactMsg.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.common.RedactMsg} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.common.RedactMsg}
 */
proto.common.RedactMsg.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.common.RedactMsg.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.common.RedactMsg.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.common.RedactMsg} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.RedactMsg.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!(string|Uint8Array)}
 */
proto.common.RedactMsg.prototype.getPk = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.common.RedactMsg.prototype.getPk_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getPk()));
};
 ...
 * @return {!Uint8Array}
 */
proto.common.RedactMsg.prototype.getPk_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getPk()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.common.RedactMsg} returns this
 */
proto.common.RedactMsg.prototype.setPk = function(value) {
  return jspb.Message.setProto3BytesField(this, 1, value);
};


/**
 * optional bytes msp = 2;
 * @return {!(string|Uint8Array)}
 */
proto.common.RedactMsg.prototype.getMsp = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
...
/**
 * optional bytes msp = 2;
 * This is a type-conversion wrapper around `getMsp()`
 * @return {string}
 */
proto.common.RedactMsg.prototype.getMsp_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getMsp()));
};
 ...
 * @return {!Uint8Array}
 */
proto.common.RedactMsg.prototype.getMsp_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getMsp()));
};
 ...
 * @return {!proto.common.RedactMsg} returns this
 */
proto.common.RedactMsg.prototype.setMsp = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};


/**
 * optional bytes fame_cipher = 3;
 * @return {!(string|Uint8Array)}
 */
proto.common.RedactMsg.prototype.getFameCipher = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
...
/**
 * optional bytes fame_cipher = 3;
 * This is a type-conversion wrapper around `getFameCipher()`
 * @return {string}
 */
proto.common.RedactMsg.prototype.getFameCipher_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getFameCipher()));
};
 ...
 * @return {!Uint8Array}
 */
proto.common.RedactMsg.prototype.getFameCipher_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getFameCipher()));
};
 ...
 * @return {!proto.common.RedactMsg} returns this
 */
proto.common.RedactMsg.prototype.setFameCipher = function(value) {
  return jspb.Message.setProto3BytesField(this, 3, value);
};
